...
import AttachmentTemplate from "./Templates/AttachmentTemplate"; 
  ...
  addNewResponse = (resp) => {
    ...
    if(resp == 'restart') {
      ...
      this.getResponseCodeName(response)
        ...
        //adds drop down choice as reply from user
        ...
        botResponse.link.map(name => {
          ...
          if (messageData.type == "datepicker") {
            messageData.getMessageState = this.getMessageState; //pass down ability to retrieve state
            messageData.setMessageState = this.setMessageState; //pass down ability to set state
            messageData.dateFormatter = this.formatDate;
          }


          //will pass ability to change/retrieve state to dropdown message types
    ...
    return (
      ...
      }
      {
        ...
        <Chat
          ...
          message={this.CustomChatMessage} 
